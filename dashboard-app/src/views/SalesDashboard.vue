<template>
  <div class="text-slate-800 p-2 sm:p-4 font-sans">
    <div class="max-w-[1600px] mx-auto">
      
      <header class="flex flex-col xl:flex-row justify-between items-center bg-white/80 backdrop-blur-md px-4 sm:px-6 py-3 rounded-2xl shadow-sm border border-slate-100 mb-4 gap-3 xl:gap-0">
    ...
    <main v-if="isInitialized" id="report-content">
      
      <div v-if="selectedMarket === 'ALL'" class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div class="flex flex-col gap-4" :class="hasReports ? 'lg:col-span-8 xl:col-span-9' : 'lg:col-span-12'">
        ...
        <div v-show="hasReports" class="lg:col-span-4 xl:col-span-3 h-full min-w-0">
          <div class="animate-fade-in-right h-full">
